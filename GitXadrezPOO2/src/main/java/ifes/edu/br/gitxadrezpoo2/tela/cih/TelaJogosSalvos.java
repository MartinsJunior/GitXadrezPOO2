...
public class TelaJogosSalvos extends javax.swing.JFrame {
    ...
    private void preencheTabela() {
        ...
        dtm.setNumRows(0);
        Object[] vetor = new Object[7];
        ArrayList<Jogo> listaJogosAtuais = ctrlJogosSalvos.busca();
        for (Jogo jogo : listaJogosAtuais) {
            Jogador branco = jogo.getJogador(0);
            Jogador preto = jogo.getJogador(1);
            vetor[0] = jogo.getnomeJogo();
            vetor[1] = jogo.getData();
    ...
    private int getId() {
        ...
        Object obj = mode.getValueAt(i, 6);
    ...
    private void recomecarJogo() {
        ...
        ctrlJogosSalvos.recomecaJogo(getId());
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome do Jogo", "Data/Hora do Jogo", "Nome Jogador Branco", "Pontos", "Nome Jogador Preto", "Pontos", "Id"
            }
        ) {
