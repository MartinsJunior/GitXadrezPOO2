...
import ifes.edu.br.gitxadrezpoo2.bd.cgd.RegistraEmBancoDeDados;
...
public class AplPrincipal {
    ...
    public AplPrincipal(Jogo jogo) {
        this.tabuleiro = Diretor.getInstance().ConstroiTabuleiro();
        this.jogo = jogo;
    }
    ...
    RegistraEmBancoDeDados registraEmBancoDeDados = new RegistraEmBancoDeDados();
    ...
    public boolean salvarJogo(String nomeJogo) {
        ...
        registraEmBancoDeDados.SalvaJogoCompleto(jogoCompleto);
        return true;
